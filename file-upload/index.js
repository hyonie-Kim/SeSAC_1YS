...
app.post("/upload-single", upload.single("userfile"),(req,res)=> { //upload.single 로 받음, 여기서 single이라는 함수는 파일 하나만 보낼때 사용
...
app.post("/upload-array", upload.array("userfile"),(req,res)=> { //upload.single 로 받음, 여기서 single이라는 함수는 파일 하나만 보낼때 사용
